...
export default function UserTable() {
  ...
  return (
    <div className="mt-4 px-0" style={{ fontSize: '14px' }}>
      <div
        className="table-s overflow-auto d-none d-md-block"
        style={{ borderRadius: '12px' }}
      >
        <table
          className="table table-hover align-start mb-0"
          style={{ borderRadius: '12px', overflow: 'hidden' }}
        >
          <thead
            className="table-light fw-medium py-2"
            style={{
              borderRadius: '6px',
              paddingBlock: '8px',
              color: '#505470',
          ...
          <tbody>
            {data.map((item, index) => (
              <tr key={index}>
                ...
                <td className="" style={{ width: '120px', fontSize: '12px' }}>
                  {item.carComfort}
                </td>
                <td style={{ width: '140px', fontSize: '12px' }}>
                  {item.orderedTime}
                </td>
                <td style={{ width: '200px', fontSize: '12px' }}>
                  {item.startLocation}
                </td>
                <td style={{ width: '180px', fontSize: '12px' }}>
                  {item.finishLocation}
                </td>
